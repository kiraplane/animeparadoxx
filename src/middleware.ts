...
const retiredPublicRouteRedirects: Array<{
  ...
  { pattern: /^\/animeparadoxx-codes?\/?$/, target: '/codes' },
  { pattern: /^\/animeparadoxx-codes?\/?$/, target: '/codes' },
  {
    pattern: /^\/animeparadoxx-tier-list\/?$/,
    target: '/tier-list',
  },
  { pattern: /^\/anime-paradox-x-wiki\/?$/, target: '/' },
...
export default async function middleware(req: NextRequest) {
  ...
  const productionHosts = new Set([
    'animeparadoxx.wiki',
    'www.animeparadoxx.wiki',
  ]);
  const canonicalHost = 'www.animeparadoxx.wiki';
