...
export async function generateMetadata({
  ...
  return constructMetadata({
    title: 'Cookie Policy | Anime Paradox X Wiki',
    description:
      'How Anime Paradox X Wiki uses essential cookies, analytics, and similar technologies.',
    locale,
    pathname: '/cookie',
  });
}
    ...
    <div className="bg-[#080607] py-12 text-[#F8FAFC]">
      <Container className="max-w-3xl space-y-6 px-4">
        ...
        <p className="leading-8 text-[#CBD5E1]">
          Anime Paradox X Wiki uses essential cookies and similar technologies
        ...
        <p className="leading-8 text-[#CBD5E1]">
          Questions about this policy can be sent to hello@animeparadoxx.wiki.
        </p>
      </Container>
    </div>
  );
