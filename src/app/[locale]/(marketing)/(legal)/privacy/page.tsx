...
export async function generateMetadata({
  ...
  return constructMetadata({
    title: 'Privacy Policy | Anime Paradox X Wiki',
    description:
      'Privacy policy for the independent Anime Paradox X Wiki and Roblox guide site.',
    locale,
    pathname: '/privacy',
  });
}
    ...
    <div className="bg-[#080607] py-12 text-[#F8FAFC]">
      <Container className="max-w-3xl space-y-6 px-4">
        ...
        <p className="leading-8 text-[#CBD5E1]">
          Anime Paradox X Wiki is an independent Roblox guide site. We do not
          require accounts for browsing codes, tier notes, unit profiles,
          traits, evolution, update coverage, official links, or safety pages.
        </p>
        <p className="leading-8 text-[#CBD5E1]">
        ...
        <p className="leading-8 text-[#CBD5E1]">
          Privacy questions can be sent to hello@animeparadoxx.wiki.
        </p>
      </Container>
    </div>
  );
