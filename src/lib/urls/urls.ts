...
export const CANONICAL_BASE_URL = 'https://www.animeparadoxx.wiki';
...
function getAnimeParadoxXBaseUrl(url?: string) {
  ...
  try {
    ...
    if (
      parsedUrl.hostname === 'animeparadoxx.wiki' ||
      parsedUrl.hostname === 'www.animeparadoxx.wiki'
    ) {
...
export function getBaseUrl(): string {
  ...
  const animeparadoxxBaseUrl = getAnimeParadoxXBaseUrl(configuredBaseUrl);
  if (animeparadoxxBaseUrl) {
    return animeparadoxxBaseUrl;
  }
