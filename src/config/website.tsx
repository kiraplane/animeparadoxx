...
export const websiteConfig: WebsiteConfig = {
  ...
  metadata: {
    images: {
      ogImage: '/animeparadoxx/media/official-1.png',
      logoLight: '/animeparadoxx/icon.png',
      logoDark: '/animeparadoxx/icon.png',
    },
    social: {
      github: '',
      twitter: 'https://x.com/LunmeiGames',
      blueSky: '',
      discord: 'https://discord.com/invite/animeparadox',
      mastodon: '',
      linkedin: '',
      youtube: '',
    },
  ...
  mail: {
    provider: 'resend',
    fromEmail: 'Anime Paradox X Wiki <hello@animeparadoxx.wiki>',
    supportEmail: 'hello@animeparadoxx.wiki',
  },
  newsletter: {
    enable: false,
    provider: 'resend',
